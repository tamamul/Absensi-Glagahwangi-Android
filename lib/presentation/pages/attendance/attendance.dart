                        ...
                        children: [
                          _buildAttendanceCard(
                            ...
                            attendanceStatus != null &&
                                attendanceStatus != 'absen' && attendanceStatus != 'lembur'
                                ? attendanceStatus
                                : inData != null
                                ? inData['time'] ?? "Belum"
                                : "Belum",
                      ...
                      children: [
                        ...
                        Switch(
                          ...
                          onChanged: (bool value) {
                            ...
                            if (hour < 11 || (hour == 11 && minute <= 45) || !_checkedIn || _checkedOut || _hasDinas || _hasPermission) {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: const Text(
                                ...
                                return AlertDialog(
                                  ...
                                  actions: [
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        Navigator.pop(context);
                                        context.read<AttendanceBloc>().add(RecordOvertime(
                                          authUser.id!,
                                          DateTime.now(),
                                        ));
                                      },
                        ...
                        builder: (context, state) {
                          if (state is AttendanceLoading) {
                            ...
                            if (state.hasDinas) {
                              ...
                              }else if(state.dinasStatus == "approved"){
                                return Container(
                                  height: 190,
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(8),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomButton(
                                          ...
                                          textSize: 18,
                                          textColor: ColorPalette.main_yellow,
                                          buttonColor: Colors.white,
                                        ),
                                      ],
                                    ),
                    ...
                    if (state is AttendanceLoading) {
                      ...
                      if (_hasPermission && !_hasCheckedIn && !_hasCheckedOut) {
                        if (state.permissionStatus == "pending") {
                          return CustomButton(
                            text: "Izin Non-Dinas Sedang Diproses",
                            onPressed: () {},
                            textSize: 15,
                            textColor: Colors.white,
                        ...
                        if(state.dinasStatus == "approved"){
                          ...
                          return CustomButton(
                            text: "Pengajuan Dinas Sedang Berlangsung",
                            onPressed: () {
                              if(_hasCheckedIn){
                                Navigator.push(
                                  context,
                          ...
                          return CustomButton(
                            text:
                            "Izin Ditolak, Absen atau Ajukan Izin Ulang",
                            onPressed: () {
                              if(_hasCheckedIn){
                                Navigator.push(
                                  context,
